        ...
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <div className="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden ring-1 ring-gray-200/5 lg:w-1/2">
              <svg
                className="absolute  inset-0 h-full w-full  stroke-gradient-to-r from-red-500 via-pink-600 to-red-600  [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]"
                aria-hidden="true"
              >
                <defs>
                  <pattern
              ...
              >
                <div
                  className="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-br from-[#80caff] to-[#4f46e5] opacity-40"
                  style={{
                    clipPath:
            ...
            <dl className="mt-10 space-y-4 text-base leading-7 text-gray-300">
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a className="hover:text-white" href="tel:+91-7000201383">
                    +91-7000201383
                  </a>
                </dd>
              </div>
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a
                    ...
                    href="mailto:abhi7000201383@gmail.com"
                  >
                    abhi7000201383@gmail.com
                  </a>
                </dd>
              </div>
            </dl>
